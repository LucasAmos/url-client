...
export default function Footer() {
  return (
    <div className="footer">
      <a href="https://github.com/LucasAmos/" target="_blank" rel="noopener noreferrer">
        <img src={githubwhite} className="image" alt="github logo" />
      </a>
      ...
      <a href="https://www.npmjs.com/~lucasamos" target="_blank" rel="noopener noreferrer">
        <img src={npm} className="image" alt="npm logo" />
      </a>
    </div>
  );
}
